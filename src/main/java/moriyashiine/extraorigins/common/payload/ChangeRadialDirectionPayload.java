...
public record ChangeRadialDirectionPayload(RadialMenuDirection direction, Identifier power) implements CustomPayload {
	public static final Id<ChangeRadialDirectionPayload> ID = new Id<>(ExtraOrigins.id("change_radial_direction"));
	public static final PacketCodec<RegistryByteBuf, ChangeRadialDirectionPayload> CODEC = PacketCodec.tuple(RadialMenuDirection.PACKET_CODEC, ChangeRadialDirectionPayload::direction, Identifier.PACKET_CODEC, ChangeRadialDirectionPayload::power, ChangeRadialDirectionPayload::new);
	...
	public static void send(RadialMenuDirection direction, Identifier power) {
