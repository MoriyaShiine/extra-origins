...
public class EOPowers {
	...
	public static final PowerType<Power> BITE_SIZED = create("bite_sized", PowerTypeAccessor.createPowerType(((powerType, playerEntity) -> new AttributePower(powerType, playerEntity)
			...
			.addModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(UUID.fromString("286e76f1-38ec-45e4-8242-93e1c34127d0"), "Movement speed mod", -0.05 , EntityAttributeModifier.Operation.ADDITION))
